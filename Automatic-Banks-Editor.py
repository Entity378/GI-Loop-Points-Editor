...
if __name__ == "__main__":
    automaticMode = False
    while True:
        print("Automatic mode: checks all banks.bnk files in the same folder as the script and modifies them")
        choice = input("Do you want to enable automatic mode? (y/n):").strip().lower()
        if choice in ('y', 'n'):
            automaticMode = True
            break
        else:
    ...
    if automaticMode == True:
        ...
        for i in range(32):
            ...
            if positions:
                ...
                print("Loop-points changed correctly.")
            else:
